...
try {
  ...
  // Retrieve product details based on ID passed in URL
...
<div class="container">
        <div class="row">
            <div class="col-md-4">
                <img src="<?php echo $product['photo']; ?>" class="img-fluid" alt="Product Image">
            </div>
            <div class="col-md-7">
                <br>
                <h2><?php echo $product['produit']; ?></h2>
                ...
                <div class="form-group">
                    <br>
                    <h4 for="quantity">Contactez-Nous pour Plus d'informations</h4>
                </div>
                <hr>
                <a href="https://wa.me/212661096691" target="_blank" class="btn btn-primary py-md-3 px-md-5 d-lg-block"  style="background-color: #41DE5D;"><i class="fab fa-whatsapp me-2" id="wh"></i>Whatsapp</a>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0">+212 661 096 6910</p>
                        </div>
